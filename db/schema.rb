...
ActiveRecord::Schema.define(:version => 20130513164141) do
  ...
  create_table "rooms", :force => true do |t|
    ...
    t.string   "color"
    t.string   "gpio_light_number"
    t.integer  "temperature_channel"
    t.integer  "light_channel"
    t.integer  "light_measure"
  end
