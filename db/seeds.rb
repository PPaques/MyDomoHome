...
Room.create(name: "Salon",      gpio_heat_number: 15,heating: false, light: false, temperature: 20, home: Home.first, isoutside: false)
Room.create(name: "Cuisine",    gpio_heat_number: 18,heating: false, light: false, temperature: 20, home: Home.first, isoutside: false)
Room.create(name: "Chambre",    gpio_heat_number: 23,heating: false, light: false, temperature: 20, home: Home.first, isoutside: false)
